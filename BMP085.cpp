/*
  BarometricPressure.cpp - Library for  Barometric Pressure sensor.
...
char BarometricPressure::Read(unsigned char address)
{
...
int BarometricPressure::ReadInt(unsigned char address)
{
